...
const translations: Record<Lang, Translations> = {
	en: {
		...
		'guided.sprites': '🖼️ Sprites / Icons',
		'guided.add_sprite': '＋ Add sprite',
		'guided.remove_sprite': 'Remove sprite',
		'guided.sprite_search': 'Search sprites…',
		'guided.sprite_categories_units': 'Units',
		'guided.sprite_categories_food': 'Animals & Food',
		'guided.sprite_categories_resources': 'Resources',
		'guided.sprite_categories_buildings': 'Buildings',
		'guided.sprite_categories_technologies': 'Technologies',
		'guided.sprite_categories_age': 'Age-up',
		'guided.sprite_categories_aom': 'AoM',
		...
		'community.tagline': 'Approved build orders submitted by the community',
		'community.filter_civ': 'Civilization',
		'community.all_civs': 'All',
		'community.no_results': 'No community builds match your filters.',
		'community.load': '▶ Load in viewer',
		'community.submitted_by': 'by',
		'community.empty': 'No community builds have been approved yet. Be the first to submit one!',
		'community.back': '← Back to library',

		// Builder – submit
		'builder.submit': '📤 Submit to Community',
		'builder.submit_modal_title': 'Submit to Community',
		'builder.submit_modal_body': 'Your build order will be reviewed by a moderator before appearing publicly.',
		'builder.submit_email_label': 'Email (optional, to be notified when approved)',
		'builder.submit_email_placeholder': 'your@email.com',
		'builder.submit_rules': 'I agree to the community guidelines and confirm this build order is my own work.',
		'builder.submit_btn': 'Submit for review',
		'builder.submit_success': '✅ Submitted! Your tracking ID: {id}',
		'builder.submit_error': '❌ Submission failed: {error}',
		'builder.submit_cancel': 'Cancel',

		// Admin
		'admin.title': '🛡️ Admin – Moderation',
		'admin.login_title': 'Admin Login',
		'admin.login_email': 'Email address',
		'admin.login_btn': 'Send magic link',
		'admin.login_sent': '✅ Magic link sent! Check your inbox.',
		'admin.login_error': 'Login failed: {error}',
		...
		'admin.notes_label': 'Moderator notes (optional)',
		'admin.notes_placeholder': 'Internal note about this build order…',
		'admin.moderate_success': 'Build order updated.',
		'admin.moderate_error': 'Error: {error}',
		'admin.back': '← Back to queue',
		'admin.submitted_at': 'Submitted',
		'admin.no_pending': 'No builds pending review.',
		'admin.view_btn': '👁 Review',
		'admin.tracking_id': 'Tracking ID',
	},
	fr: {
		// Navigation
		...
		'guided.sprites': '🖼️ Sprites / Icônes',
		'guided.add_sprite': '＋ Ajouter un sprite',
		'guided.remove_sprite': 'Retirer le sprite',
		'guided.sprite_search': 'Rechercher des sprites…',
		'guided.sprite_categories_units': 'Unités',
		'guided.sprite_categories_food': 'Animaux et nourriture',
		'guided.sprite_categories_resources': 'Ressources',
		'guided.sprite_categories_buildings': 'Bâtiments',
		'guided.sprite_categories_technologies': 'Technologies',
		'guided.sprite_categories_age': "Passage d'âge",
		'guided.sprite_categories_aom': 'AoM',
		...
		// Community
		'community.title': '🌍 Builds Communautaires',
		'community.tagline': 'Build orders approuvés soumis par la communauté',
		'community.filter_civ': 'Civilisation',
		'community.all_civs': 'Toutes',
		'community.no_results': 'Aucun build communautaire ne correspond à vos filtres.',
		'community.load': '▶ Charger dans le lecteur',
		'community.submitted_by': 'par',
		'community.empty': "Aucun build communautaire n'a encore été approuvé. Soyez le premier à en soumettre un !",
		'community.back': '← Retour à la bibliothèque',

		// Builder – submit
		'builder.submit': '📤 Soumettre à la communauté',
		'builder.submit_modal_title': 'Soumettre à la communauté',
		'builder.submit_modal_body': "Votre build order sera examiné par un modérateur avant d'apparaître publiquement.",
		'builder.submit_email_label': "Email (optionnel, pour être notifié en cas d'approbation)",
		'builder.submit_email_placeholder': 'votre@email.com',
		'builder.submit_rules': "J'accepte les règles de la communauté et confirme que ce build order est mon propre travail.",
		'builder.submit_btn': 'Soumettre pour examen',
		'builder.submit_success': '✅ Soumis ! Votre identifiant de suivi : {id}',
		'builder.submit_error': '❌ Échec de la soumission : {error}',
		'builder.submit_cancel': 'Annuler',

		// Admin
		'admin.title': '🛡️ Admin – Modération',
		'admin.login_title': 'Connexion Admin',
		'admin.login_email': 'Adresse email',
		'admin.login_btn': 'Envoyer le lien magique',
		'admin.login_sent': '✅ Lien envoyé ! Consultez votre boîte mail.',
		'admin.login_error': 'Connexion échouée : {error}',
		...
		'admin.notes_label': 'Notes de modération (optionnel)',
		'admin.notes_placeholder': 'Note interne sur ce build order…',
		'admin.moderate_success': 'Build order mis à jour.',
		'admin.moderate_error': 'Erreur : {error}',
		'admin.back': '← Retour à la file',
		'admin.submitted_at': 'Soumis le',
		'admin.no_pending': 'Aucun build en attente de modération.',
		'admin.view_btn': '👁 Examiner',
		'admin.tracking_id': 'Identifiant de suivi',
	},
};
